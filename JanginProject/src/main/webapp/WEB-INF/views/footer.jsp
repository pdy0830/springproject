  ...
  <footer class="footer" style="margin-top: 100px;">
    <div class="container">
      <div class="row show-grid">
        <div class="span2" style="background-color: #3a3a3a">
          <div class="widget">
            <!-- logo -->
            <div  class="footerlogo">
             <a href="/volunteer134/home">
              <img src="${pageContext.request.contextPath}/resources/Plato/assets/img/logoGray.png" alt=""  style=" width: 170px; height: 65px;"/> 
             </a>
            </div>
            <!-- end logo -->
            <address>
            <strong>Kitri Volunteer134, Inc.</strong><br>
             Guro Digital Complex<br>
             Seoul, Korea<br>
            <abbr title="Phone">P:</abbr> 010-3219-3540 </address>
          </div>
        </div>
        <div class="span3" style="background-color: #3a3a3a">
          <div class="widget">
            <h5>Browse pages</h5>
        ...
        <div class="span4" style="background-color: #3a3a3a">
          <div class="widget" style="width: 700px;  height: 180px;">
            <h5>Developers &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="https://www.instagram.com/yoonzigonzi/" style="font-style: white">신윤지</a> &nbsp;
            <a href="https://www.instagram.com/myiqisfifteen/">황신지</a>  &nbsp;
              <a href="https://www.instagram.com/hyojin_203/">윤효진</a> &nbsp;
                <a href="https://www.instagram.com/day.eone/">박다연</a> &nbsp;
                 </h5>
           <img src="${pageContext.request.contextPath}/resources/Plato/assets/img/woodangtang.PNG" alt="" style=" height: 200px;"/> 
          </div>
        </div>
